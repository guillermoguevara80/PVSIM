...
function respuestproducto(valor){
    $.ajax({
		...
		url : "/papers/buscar_libro2/",
		type : "GET",
		data : { valor : valor,},
		success : function(json){

            valor_retornado = "<h2 style='text-align:center;'>"+json[0].titulo+"</h2>"+ "<img style='width:100%;' src='/media/" + json[0].ruta_imagen + "'/>"
